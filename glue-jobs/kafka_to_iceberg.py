...
spark = SparkSession.builder \
    .appName(args.get('JOB_NAME', 'kafka-to-iceberg')) \
    ...
    .config("spark.sql.catalog.s3a.catalog-impl", "org.apache.iceberg.aws.glue.GlueCatalog") \
...
def process_batch(df, epoch_id):
    if df.count() > 0:
        ...
        final_df = parsed_df.select(
            ...
            from_unixtime(col("after.order_date") / 1000).cast("timestamp").alias("order_date"),
